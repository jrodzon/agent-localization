...
Plane segmentation started drawing more attention at the beginning of the 2010s with the availability of inexpensive RGB-D sensors
...
Then, it calculates the quality of the inlier by counting how many neighbors within range $d_n$
            ...
            \For{$i = 1$ \textbf{to} $n$}{
                \If{$\hat{\xi_i}$ is invalid}{
                    ...
                    \eIf{$N_s > N_{s thresh}$}{
                        ...
                        distance threshold $d_{\tau}$ and neighbor distance
                        threshold $d_n$ \\

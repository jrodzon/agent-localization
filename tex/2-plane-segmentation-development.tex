...
\section{RGB state-of-the-art}

The current state-of-the-art RGB plane segmentation is represented by:
\begin{itemize}
\item PlaneRCNN proposed by Chen Liu et al. \cite{articlePlaneRCNN}.
\item PlaneRecNet proposed by Yaxu Xie et al. \cite{xie2021planerecnet}.
\item PlaneSegNet proposed by Yaxu Xie et al. \cite{inproceedingsPlaneSegNet}.
\end{itemize}

All of these approaches are presented in the following sections.

\subsection{PlaneSegNet}
...
The general architecture of the framework can be seen in Figure~\ref{figure:PlaneRCNN-Architecture}.
There are three main modules:
Plane detection network - This module locates planar segments
